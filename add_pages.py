...
<body>
  <div class="container">
    ...
    <h2>5. Contact</h2>
    <p>If you have any questions about these Terms, please reach out via <a href="https://x.com/gabriel_sstech" target="_blank">Twitter/X (@gabriel_sstech)</a>.</p>
  </div>
</body>
</html>'''
...
<body>
  <div class="container">
    ...
    <h2>5. Contact Us</h2>
    <p>For any privacy-related concerns, please contact us via <a href="https://x.com/gabriel_sstech" target="_blank">Twitter/X (@gabriel_sstech)</a>.</p>
  </div>
</body>
</html>'''
